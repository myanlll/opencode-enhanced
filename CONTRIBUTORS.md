...
See [`NOTICE.md`](./NOTICE.md) for full attribution to the upstream projects this repository builds on:

- [opencode](https://github.com/anomalyco/opencode) and its contributors
- [Kilo Code](https://github.com/Kilo-Org/kilocode) and its contributors
